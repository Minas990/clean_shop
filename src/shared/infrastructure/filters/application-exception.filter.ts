...
import { ApplicationException, ApplicationExceptionCode } from "../../domain/exceptions/application.exception";
import { Response } from "express";

const CODE_TO_HTTP_STATUS: Record<ApplicationExceptionCode, number> = 
{
